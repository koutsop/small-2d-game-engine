...
void Arcanoid::Init (const std::string& path) {
	...
	bg			= engine::LoadBitmapFromFile(terrain.GetBackgroundImgPath());
	pause		= engine::LoadBitmapFromFile(terrain.GetPausedImgPath());
	gameover	= engine::LoadBitmapFromFile(terrain.GetGameOverImgPath());
